                        ...
                        <aside className="col-lg-6">
                            <div className="border rounded-4 mb-3 d-flex justify-content-center">
                                <a data-fslightbox="mygalley" className="rounded-4" target="_blank" data-type="image" href="/">
                                    <img style={{ maxWidth: "100%", maxHeight: "100vh", margin: "auto" }} className="rounded-4 fit" src="/images/rendero.png" alt='Rendero-pc' />
                                </a>
                            </div>
                            {/* <div className="d-flex justify-content-center mb-3">
                                <a data-fslightbox="mygalley" className="border mx-1 rounded-2 item-thumb" target="_blank" data-type="image" href="/" >
                                    <img width="60" height="60" className="rounded-2" src="/images/Rendero.png" alt='Rendero-pc' />
                                </a>
                                <a data-fslightbox="mygalley" className="border mx-1 rounded-2 item-thumb" target="_blank" data-type="image" href="/" >
                                    <img width="60" height="60" className="rounded-2" src="/images/Rendero.png" alt='Rendero-pc' />
                                </a>
                        ...
                        <main className="col-lg-6">
                            <div className="ps-lg-3">
                                ...
                                <div className="container">
                                    <h1>Rendero</h1>
                                    <ul>
                                        <li>Intel Core i9-13400KS (10 Cores/16 Threads)</li>
                                        <li>MSI Pro B650M-A CEC DDR4 WiFi Motherboard</li>
                                        <li>NVIDIA GeForce RTX 3060 </li>
                                        <li>Cooler Master Hyper 212 Air Cooler</li>
                                        <li>24GB T-FORCE DELTA RGB DDR4 3600MHz Memory (16GB+8GB)</li>
                                        <li>1TB Solidigm P41 M.2 </li>
                                ...
                                <hr />
                                <div class="mb-3">
                                    <h5 className='price' id='RenderoPrice'>₹1,29,999</h5>
                                </div>
