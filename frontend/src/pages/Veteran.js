                        ...
                        <aside className="col-lg-6">
                            <div className="border rounded-4 mb-3 d-flex justify-content-center">
                                <a data-fslightbox="mygalley" className="rounded-4" target="_blank" data-type="image" href="/">
                                    <img style={{ maxWidth: "100%", maxHeight: "100vh", margin: "auto" }} className="rounded-4 fit" src="/images/veteran.png" alt='Veteran-pc' />
                                </a>
                            </div>
                            {/* <div className="d-flex justify-content-center mb-3">
                                <a data-fslightbox="mygalley" className="border mx-1 rounded-2 item-thumb" target="_blank" data-type="image" href="/" >
                                    <img width="60" height="60" className="rounded-2" src="/images/Veteran.png" alt='Veteran-pc' />
                                </a>
                                <a data-fslightbox="mygalley" className="border mx-1 rounded-2 item-thumb" target="_blank" data-type="image" href="/" >
                                    <img width="60" height="60" className="rounded-2" src="/images/Veteran.png" alt='Veteran-pc' />
                                </a>
                        ...
                        <main className="col-lg-6">
                            <div className="ps-lg-3">
                                ...
                                <div className="container">
                                    <h1>Veteran</h1>
                                    <ul>
                                        <li>Intel Core i7-13400F (10 Cores/16 Threads)</li>
                                ...
                                <hr />
                                <div class="mb-3">
                                    <h5 className='price' id='VeteranPrice'>₹89,999</h5>
                                </div>
